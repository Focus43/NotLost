...
- (void)itemsWillAppearFromButton:(UIButton *) button inView:(UIView *)view {
	...
	while (currentItem <= itemCount) {
		...
		CGRect frame = CGRectMake(centerX-buttonSize*0.5f, centerY-buttonSize*0.5f, 38, 44);
        ...
        [popupButton setImage:[self.delegate radialMenu:self highlightImageForIndex:currentItem] forState:UIControlStateHighlighted];
        [popupButton setEnabled:[self.delegate radialMenu:self buttonEnabledAtIndex:currentItem]];
...
- (BOOL)buttonsWillAnimateFromButton:(id)sender inView:(UIView *)view {
