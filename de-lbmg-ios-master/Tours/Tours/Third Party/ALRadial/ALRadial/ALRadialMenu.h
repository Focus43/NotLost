...
/**
 * delegate's should return the highlight image to be displayed at the the given index
 * @return image to be displayed
 * @param radialMenu the radial menu object making the request
 * @param index the item to be displayed
 */
...
/**
 * delegate's shoudl return the state of the button (enabled/true or disabled/false)
 * @param radialMenu the radial menu object making the request
 * @param index the item to be enabled/disabled
 */
